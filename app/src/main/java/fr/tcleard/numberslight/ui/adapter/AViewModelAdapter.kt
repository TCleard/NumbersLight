...
abstract class AViewModelAdapter<VM : AViewModel<*, F>, VH : AViewHolder<VM>, F : AViewHolderFactory<VH>>(
        protected val viewHolderFactory: F
) : AItemAdapter<VM, VH>() {
    ...
    override fun getItemViewType(position: Int): Int =
            items[position].accept(viewHolderFactory)
